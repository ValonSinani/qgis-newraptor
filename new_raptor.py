...
class NewRaptor:
    ...
    def initGui(self):
        ...
        self.add_action(
            icon_path,
            text=self.tr(u'add New Rapotor Nest'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            QMessageBox.information(self.dlg, "Message", "New Nest ID: {}\nLatitude:{}\nLongitude:{}\nSpecies:{}\nStatus:{}\Survey:{}".format(valNestID, valLat, valLng, valSpecies, valSpecies, valBuffer, valStatus, valLast))
            ...
            ftrNest.setAttribute("buf_dist", valLast)
            ...
            QMessageBox.information(self.dlg, "Message", "Schould only run if cancelled")
